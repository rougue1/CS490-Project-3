...
class UpdateUserTestCase(unittest.TestCase):
    ...
    def mocked_edit_transaction(self, transaction_id, base):

        # print("The trans" + str(transaction_id))
        # print(self.initial_db_mock)
        self.initial_db_mock[transaction_id] = {
            'type': base["type"],
            'amount': base["amount"],
            'date': base["date"],
    ...
    def test_success(self):
        ...
        for test in self.success_test_params:
            with patch('app.final_edit_transaction',
                       self.mocked_edit_transaction):

                actual_result = update_user_info(test[KEY_DATA],
                                                 test[KEY_INPUT])
...
class DeleteUserTestCase(unittest.TestCase):
    ...
    def test_success(self):
        for test in self.success_test_params:
            with patch('app.final_delete_transaction',
                       self.mocked_delete_transaction):

                actual_result = delete_user_task(test[KEY_DATA],
                                                 test[KEY_INPUT])
