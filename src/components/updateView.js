      ...
      <Modal show={show} onHide={onHide} backdrop="static" keyboard={false}>
        ...
        <Form onSubmit={onUpdate}>
          <Modal.Body>
            ...
            <Form.Control required className="form-control" name="amount" defaultValue = {list.amount} step="0.01" precision="2" min="0" />
