...
class UpdateUserTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.success_test_params_get_user_info = [
            {
                USER_NAME: 'Aman Hirpara',
                DATA_INPUT: [{'transaction_type': 'Income', 'amount': 20}],
                EXPECTED_OUTPUT: {'full_name': 'Aman Hirpara', 'balance': 20, 'income': 20, 'expense': 0}
            },
            {
                USER_NAME: 'Aman Hirpara',
                DATA_INPUT: [{'transaction_type': 'Expense', 'amount': 20}],
                EXPECTED_OUTPUT: {'full_name': 'Aman Hirpara', 'balance': -20, 'income': 0, 'expense': 20}
            },
            {
                USER_NAME: 'Aman Hirpara',
                DATA_INPUT: [{'transaction_type': 'Income', 'amount': 20}, {'transaction_type': 'Expense', 'amount': 20}],
                EXPECTED_OUTPUT: {'full_name': 'Aman Hirpara', 'balance': 0, 'income': 20, 'expense': 20}
            },
            {
                USER_NAME: 'Aman',
                DATA_INPUT: [{'transaction_type': 'Income', 'amount': 40}, {'transaction_type': 'Expense', 'amount': 20}],
                EXPECTED_OUTPUT: {'full_name': 'Aman', 'balance': 20, 'income': 40, 'expense': 20}
            },
            {
                USER_NAME: 'Hirpara',
                DATA_INPUT: [{'transaction_type': 'Income', 'amount': 20}, {'transaction_type': 'Expense', 'amount': 40}],
                EXPECTED_OUTPUT: {'full_name': 'Hirpara', 'balance': -20, 'income': 20, 'expense': 40}
            }
        ]
